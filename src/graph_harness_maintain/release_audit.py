...
def audit_release_surface(repo_root: Path) -> dict:
    ...
    checks = {
        ...
        "readme_scope": _check("v1.0" in readme_text.lower() and "v1.1" in readme_text.lower(), "README explains v1.0 and v1.1 scope"),
        "readme_artifact_paths": _check("artifacts/v1/" in readme_text and "artifacts/v1.1/" in readme_text, "README explains v1 and v1.1 artifact paths"),
        "readme_safety_boundary": _check("safety boundary" in readme_text.lower(), "README explains safety boundary"),
